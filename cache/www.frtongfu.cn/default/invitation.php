...
<div id="container">
    <div class="cart_top" style="background: #008cd7;">
        <div class="title" onclick="history.back()" style="color: #fff;text-align:center;"><span style="float:left"><i class="fa fa-chevron-left" ></i>&nbsp;</span>推广码</div>
    </div>
    <div class="qrcode">
        <div id="slogen">了却皱、疤、黑之忧</div>
        <div class="user-name">会员：<?php  echo empty($member['nickname'])?$member['mobile']:$member['nickname'];?>	的推广码</div>
        <img src="<?php echo $qrurl;?>?time=<?php echo time();?>" style="width: 200px;height: 200px;">
        <!-- <a class="qrcode-address" href="#">可转发朋友圈或是印宣传单上</a>
        <a href="#" class="qrcode-a">长按二维码可保存到手机</a>-->

    </div>
    <div id='cartempty'>
        <!--<div class="card_no" ><span style="line-height:18px; font-size:16px;">扫描二维码完成注册即可完成推广</span></div>-->
        <div>扫此码，进商城，点"我的"</div>
        <div>点出"我的推广码"（有您微信名）</div>
        <div>截屏发送给朋友</div>
        <div>分享好信息、顺道开财源</div>
        <div>百万千万不是梦</div>
    </div>
