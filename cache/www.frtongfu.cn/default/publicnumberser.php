...
<div id="container">
    ...
    <div class="cart_top" style="background: #008cd7;">
        <div class="title" onclick="history.back()" style="color: #fff;text-align:center;"><span style="float:left"><i class="fa fa-chevron-left" ></i>&nbsp;</span>微信公众号</div>
    </div>
    <div class="qrcode">
        <img src="http://www.frtongfu.cn/themes/default/__RESOURCE__/images/publicnumberser.jpg" />
    </div>
