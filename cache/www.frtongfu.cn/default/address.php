...
<head>
 ...
 <meta name="viewport" content="initial-scale=1.0,maximum-scale=1.0,user-scalable=no">
	...
	<script type="text/javascript" src="http://www.frtongfu.cn/themes/default/__RESOURCE__/script/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="http://www.frtongfu.cn/themes/default/__RESOURCE__/script/common.js"></script>
	<link type="text/css" rel="stylesheet" href="http://www.frtongfu.cn/themes/default/__RESOURCE__/mobile/style/bootstrap.css">
	<script type="text/javascript" src="http://www.frtongfu.cn/themes/default/__RESOURCE__/script/bootstrap.js"></script>
	<script type="text/javascript" src="http://www.frtongfu.cn/themes/default/__RESOURCE__/script/angular.min.js"></script>
	<link type="text/css" rel="stylesheet" href="http://www.frtongfu.cn/themes/default/__RESOURCE__/recouse/css/font-awesome.min.css" />
	<link type="text/css" rel="stylesheet" href="http://www.frtongfu.cn/themes/default/__RESOURCE__/mobile/style/common.mobile.css">
	<link type="text/css" rel="stylesheet" href="http://www.frtongfu.cn/themes/default/__RESOURCE__/mobile/style/style.css">
	<script type="text/javascript" src="http://www.frtongfu.cn/themes/default/__RESOURCE__/script/cascade.js"></script>
	<script type="text/javascript" src="http://www.frtongfu.cn/themes/default/__RESOURCE__/mobile/script/jquery.touchwipe.js"></script>
	<script type="text/javascript" src="http://www.frtongfu.cn/themes/default/__RESOURCE__/mobile/script/swipe.js"></script>
...
<div class="head" style="background-color:#008cd7;">
		<?php  if(!empty($from)) { ?>
		<?php  if(!empty($returnurl)) { ?>
			<a href="<?php  echo $returnurl;?>" class="bn pull-left" style="font-size:21px;">
			<?php  } else { ?>
					<?php  if(!empty($from)) { ?>
						<a href="<?php  echo mobile_url($from)?>" class="bn pull-left" style="font-size:21px;">
						<?php  } else { ?>
	<a href="<?php  echo mobile_url('fansindex')?>" class="bn pull-left" style="font-size:21px;">
						<?php  } ?>
		<?php  } ?>
		<?php  } else { ?>
	...
	<span class="title" style="color:#fff;font-weight: normal;font-size:16px;font-family: "Helvetica Neue", Helvetica, sans-serif;">我的地址</span>
	 ...
	 <span><?php  echo $row['province'];?> <?php  echo $row['city'];?> <?php  echo $row['area'];?> <?php  echo $row['address'];?> <br/> <?php  echo $row['realname'];?>, <?php  echo $row['mobile'];?></span>
                    <br/><span>
                           <a href="javascript:;" onclick="saveDefaultAddress(event,<?php  echo $row['id'];?>)">设为默认</a>
                             <a href="javascript:;" onclick="editAddress(<?php  echo $row['id'];?>)"><i class="icon-edit"></i>修改</a>
		...
		<div class="add-address-main">
			...
			<div class="form-group">
				<div class="col-sm-12">
					...
					<button type="button" class="btn" onclick="addAddress2();$('#addAddressPanel').hide();$('#addressid').val('');">取消</button>
				</div>
			</div>
		</div>
	</div>
...
<script src="http://www.frtongfu.cn/themes/default/__RESOURCE__/recouse/js/zepto.min.js" type="text/javascript"></script>
...
<script type="text/javascript" src="http://www.frtongfu.cn/themes/default/__RESOURCE__/recouse/js/cascade.js?x=15"></script>
<script type="text/javascript">
    var from='<?php  echo $from;?>';
    var returnurl = '<?php  echo $returnurl;?>';
cascdeInit('http://www.frtongfu.cn/themes/default/__RESOURCE__/recouse/js','','','');
...
function editAddress(id) {   
	...
	$.get('<?php  echo mobile_url('address', array('op' => 'detail'))?>', {
		...
		if (s.message) {
			...
			cascdeInit('http://www.frtongfu.cn/themes/default/__RESOURCE__/recouse/js',s.message.province,s.message.city,s.message.area);
...
dropElement1.value= res.provinceName==null?'':res.provinceName;
...
dropElement2.value= res.cityName==null?'':res.cityName;
...
dropElement3.value = res.countryName==null?'':res.countryName;
  if(dropElement3.selectedIndex<0)
 {
 dropElement3.selectedIndex=0;	
 }
document.getElementById('address').value= res.detailInfo==null?'':res.detailInfo;
...
<?php } ?><?php include themePage('weixinshare');?>
