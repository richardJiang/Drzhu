...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://www.frtongfu.cn/themes/default/__RESOURCE__/plus/css/style.css?x=1467851791">
    </head>
    <body>
...
<style type="text/css">
    ...
    .header {height: auto; width:100%; padding:0px; background: url(<?php  if(empty($settings['fansindex_bg'])){?>http://www.frtongfu.cn/themes/default/__RESOURCE__/plus/images/bg11.jpg<?php }else{ ?><?php echo ATTACHMENT_WEBROOT;?><?php  echo $settings['fansindex_bg'];?><?php } ?>) 0 0 no-repeat;background-size: 100% 100%;}
...
<div id="container"></div>
    <div class="header">
        <div class="user">
            <div class="user-head"><?php  if(empty($avatar)){?><img 
                                                                src="http://www.frtongfu.cn/themes/default/__RESOURCE__/recouse/images/tx.png"/><?php  }else{ ?><img src="<?php echo $avatar;?>" /><?php  } ?></div>
            <div class="user-info">
 ...
 <div class="cart" style="margin-top: 0px;">
  <a href="javascript:;"><div style="margin-top: 0px;" class="list1" style=" border-bottom:0px;border-top:0px;">酬金余额: <span style='color:#f90'><?php  $gold=$member['gold'];$gold=sprintf("%.2f",$gold); echo $gold; ?></span> 
             <!--<div class="take" style="margin-left:10px" onclick="location.href='<?php  //echo mobile_url('rechargegold')?>'">充值</div>-->
			 <div class="take1" onclick="location.href='<?php  echo mobile_url('outchargegold')?>'">提现</div>
...
<div class="cart">
  ...
  <a href="<?php  echo mobile_url('address',array('from'=>'fansindex'))?>"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-gift" style="color:#99C;"></i>收货地址管理 <i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>	
	   ...
	   <!--<a href="https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=MzUyODAyODczNg==&scene=124#wechat_redirect"><div class="list1" style="margin:0px; border-bottom:0px;"><i class="fa fa-gift" style="color:#f10;"></i>关注微信服务号<i class="fa fa-angle-right" style="color:#999; font-size:26px; float:right; line-height:44px;"></i></div></a>	-->
