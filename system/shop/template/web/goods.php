...
<script type="text/javascript" src="<?php echo RESOURCE_ROOT;?>/addons/common/js/jquery-ui-1.10.3.min.js"></script>
 ...
 <div class="form-group">
		...
		<div class="form-group">
										<label class="col-sm-2 control-label no-padding-left" > 本店最终售价：</label>
		...
		<div class="form-group">
										<label class="col-sm-2 control-label no-padding-left" > 上一层提成</label>

										<div class="col-sm-9">
												  <input type="text" name="ffee" id="ffee" value="<?php  echo empty($item['ffee'])?'0':$item['ffee'];?>" />元
										</div>
		</div>
		<div class="form-group">
										<label class="col-sm-2 control-label no-padding-left" > 上二层提成</label>

										<div class="col-sm-9">
												  <input type="text" name="pfee" id="pfee" value="<?php  echo empty($item['pfee'])?'0':$item['pfee'];?>" />元
										</div>
		</div>
		<div class="form-group">
										<label class="col-sm-2 control-label no-padding-left" > 上三层提成</label>

										<div class="col-sm-9">
												  <input type="text" name="mfee" id="mfee" value="<?php  echo empty($item['mfee'])?'0':$item['mfee'];?>" />元
										</div>
		</div>
			...
			<div class="form-group">
          	 ...
          	 <input type="text" name="total" id="total" value="<?php  echo empty($item['total'])?'0':$item['total'];?>" /> 
					...
					<div class="form-group">
										<label class="col-sm-2 control-label no-padding-left" > 销量：</label>

										<div class="col-sm-9">
												
          	 <input type="text" name="sales" id="sales" value="<?php  echo empty($item['sales'])?'0':$item['sales'];?>" /> 
										</div>
		</div>
            ...
            <p class="help-block">会员购买商品赠送的积分, 如果不填写，则默认为不奖励积分</p>
				...
				<div class="form-group">
				  ...
				  <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
                            ...
                            <img src="<?php echo ATTACHMENT_WEBROOT;?><?php  echo $item['thumb'];?>" alt="" onerror="$(this).remove();">
                              <?php  } ?>
                            </div>
                        <div>
                ...
                <ul class="ipost-list ui-sortable" id="fileList">
                    ...
                    <li class="imgbox" style="list-style-type:none;display:inline;  float: left;  position: relative;   width: 125px;  height: 130px;">
                        <span class="item_box">
                            <img src="<?php echo ATTACHMENT_WEBROOT;?><?php  echo $v['picurl'];?>" style="width:50px;height:50px">    </span>
				...
				<div class="form-group">
										...
										<div class="col-sm-9">	
                  <textarea  id="container" name="content" ><?php  echo preg_replace('/__ATTACHMENT__/',ATTACHMENT_WEBROOT, $item['content']);?></textarea>
...
<script type="text/javascript" src="<?php echo RESOURCE_ROOT;?>addons/common/ueditor/ueditor.config.js?x=1"></script>
<script type="text/javascript" src="<?php echo RESOURCE_ROOT;?>addons/common/ueditor/ueditor.all.min.js?x=142"></script>
